...
int main(int argc, char* argv[])
{
	...
	CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","SHT_LIN","PASSWD"}, \
                {0,-1,"","SHT_BT","PASSWD"},  {0,-1,"","SHT_WIFI","PASSWD"}, \
                {0,-1,"","SHT_AND","PASSWD"},  {0,-1,"","SHT_SQL","PASSWD"}, \
                {0,-1,"","PRJ_WIFI1","PASSWD"},  {0,-1,"","PRJ_BT","PASSWD"}, \
                {0,-1,"","PRJ_SQL","PASSWD"},  {0,-1,"","PRJ_AND","PASSWD"}, \
                {0,-1,"","PRJ_LIN","PASSWD"},  {0,-1,"","11","PASSWD"}, \
